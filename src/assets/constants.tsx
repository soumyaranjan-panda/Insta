...
export const HeartIcon = ({ liked }: { liked: boolean }) => (
    ...
    >
        <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 21l-1.55-1.402C5.488 15.5 2 12.2 2 8.5 2 5.42 4.42 3 7.5 3c1.616 0 3.088.902 4.5 2.2C13.412 3.902 14.884 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.7-3.488 6.998-8.45 11.098L12 21z"
        />
    </svg>
);
